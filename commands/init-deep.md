---
description: "Generate hierarchical AGENTS.md files for this repository"
...
<critical>
**Track ALL phases in the harness todo/task tracker. Mark in_progress -> completed in real-time.**
```
Create a todo list like:
[
...
Launch parallel explore/research subagents for:
...
Launch additional explore/research subagents for:
...
```
Check whether LSP or codemap tools are available.

# Entry points (parallel)
Inspect document symbols for likely entry points such as src/index.ts or main.py.

# Key symbols (parallel)
Inspect workspace symbols for class, interface, and function definitions.

# Centrality for top exports
Find references for central exported symbols where supported.
```
...
Collect results from all background tasks/subagents.
```
...
for loc in AGENTS_LOCATIONS (except root):
  launch a writing-focused subagent/task with prompt:`
